...
fitSRS_below0 <- lm(srsScores~felt_gender_Dissonance+I(felt_gender_Dissonance^2)+truesex+Age+race_ethnicity+cbcl_scr_syn_totprob_r, data=  historya1r)
...
print(tab_model(fitSRS_below0,show.stat = TRUE,string.stat = "T-Value"))
