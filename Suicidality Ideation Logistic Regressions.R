...
Logistic_Regression_suicide_ideation <- glm(ever_ideation_4~averaged_Fluidity+EverDiverse+Age_4+truesex_1+race_ethnicity_1, data= AHHHH_suicide,family = binomial(link = "logit"))
