...
fit1 <- lm(cbcl_scr_syn_external_r~Gender_Dissonance+race_ethnicity+truesex+Age , data= historya3_Bianarized_GD_trans)
summary(fit1)
print(tab_model(fit1,show.stat = TRUE,string.stat = "T-Value"))
